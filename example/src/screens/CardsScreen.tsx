...
import {
  ...
  BannerCard, BasicCard, SettingsRowCard, StatCard, ProfileCard,
  ListItemCard, ActionCard, Icon, FlashList,
} from '@vritti/quantum-ui-native';
import { AlertCircle, Bell, Mail, Phone, Settings, Upload, User } from 'lucide-react-native';
import { Section } from '../components/Section';

export default function CardsScreen() {
  return (
    <ScrollView className="flex-1 bg-background" contentContainerClassName="p-5 pb-6 gap-6">
      <Text variant="h2" className="text-foreground">Cards</Text>
      ...
      <Section title="Basic Card">
        ...
        <BasicCard title="With Footer" footer={<Button size="sm"><Text>Go</Text></Button>} />
      ...
      <Section title="FlashList">
        <View className="h-56">
          <FlashList<{ id: string; title: string; subtitle: string; meta: string; statusColor: string }>
            data={[
